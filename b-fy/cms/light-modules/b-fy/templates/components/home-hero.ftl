<#-- Home Hero Component replicating Astro Hero. Inline (indexed) CSS for exact design parity without Tailwind. -->
<#macro homeHero 
...
>
  <#-- One-time style guard -->
  <#if !HOME_HERO_STYLE_INCLUDED??>
    <#global HOME_HERO_STYLE_INCLUDED = true />
    <style>
      /* Breakpoints mimic Tailwind (sm 640px, lg 1024px, xl 1280px) */
      ...
      .home-hero__text{max-width:728px;} /* xl:max-w-182(182*4=728) */
      .home-hero__text h1{margin-top:24px;font-weight:700;font-size:1.875rem;line-height:1.1;}/* text-3xl */
      @media (min-width:1280px){.home-hero__text h1{font-size:2.25rem;}}/* xl:text-4xl */
      .home-hero__tag{font-size:1rem;line-height:1.3;text-transform:uppercase;color:#ea580c;letter-spacing:.5px;}
      @media (min-width:1280px){.home-hero__tag{font-size:1.125rem;padding-right:60px;}}/* xl:text-lg xl:pr-15 */
      .home-hero__desc{margin:32px 0 24px;font-size:1.125rem;line-height:1.45;}/* mt-8 mb-6 text-lg */
      @media (min-width:1280px){.home-hero__desc{font-size:1.5rem;}}/* xl:text-2xl */
      .home-hero__hook{margin-top:8px;font-style:italic;font-size:2rem;color:#ea580c;line-height:1.2;}
      form.home-hero__form{max-width:636px;}/* max-w-159(159*4=636) */
      ...
      .home-hero__visual{position:relative;width:fit-content;margin:0 auto;padding:32px 20px 80px;}/* p-8 px-5 pb-20 */
      @media (min-width:640px){.home-hero__visual{padding-top:0;padding-left:100px;padding-right:72px;}}/* sm:pl-25 sm:pr-18 */
      @media (min-width:1280px){.home-hero__visual{padding-left:0;flex-shrink:0;}}/* xl:pl-0 xl:shrink-0 */
      ...
      @media (min-width:640px){.home-hero__badge{top:32px;}}/* sm:top-8 */
      @media (min-width:1280px){.home-hero__badge{left:-100px;}}/* xl:-left-25 */
  .home-hero__badge-avatar{padding:14px;border:4px solid #e5e5e5;border-radius:999px;font-size:24px;line-height:1;display:flex;align-items:center;justify-content:center;color:#ea580c;}
      ...
      @media (min-width:640px){.home-hero__card{bottom:80px;}}/* sm:bottom-20 */
      ...
      .home-hero__finger{width:73px;height:auto;margin:32px auto;}/* w-18.25 = 73px */
      @media (min-width:1280px){.max-xl\:text-center{text-align:initial;}}
    </style>
  </#if>

  <#-- Page-level overrides from content.* if present -->
  ...
  <#-- Optional DAM override for hero image if provided in page (heroImage) -->
