<#-- Home Testimonials carousel component replicating Astro layout with defaults and CMS overrides -->
<#macro homeTestimonials title="" description="">
  ...
  <#-- Resolve authored testimonial config (tagline/title/description/background) -->
  <#assign _tConf = {} />
  ...
  <#-- Resolve authored list only (no fallbacks) -->
  ...
  <#-- If nothing authored, output nothing -->
      ...
      <ul class="testimonials__slides" id="testimonials-slides">
        <#list testimonialList as t>
          <li class="testimonial">
            <figure>
              <#-- Plain textarea text: split into paragraphs by double newline, else single newline -->
