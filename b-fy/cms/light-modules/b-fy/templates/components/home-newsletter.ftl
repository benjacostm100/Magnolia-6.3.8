<#-- Newsletter section extracted to match Astro design exactly -->
<#macro homeNewsletter>
  <#-- Fetch authored newsletter node if exists -->
  ...
  <#assign nlTitle = newsletterNode.title!"Subscribe to our Newsletter" />
  <#assign nlDescription = newsletterNode.description!"Receive the latest updates on digital identity, security and authentication innovation." />
  <#assign buttonLabel = newsletterNode.buttonLabel!"Request a demo" />
  <#assign emailPlaceholder = newsletterNode.emailPlaceholder!"Enter your email" />
