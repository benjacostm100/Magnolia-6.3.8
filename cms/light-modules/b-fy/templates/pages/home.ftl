...
<main style="margin-top:70px;">
        ...
        <#assign fallbackIndustries = {
            ...
            "items":[
                {"name":"Financial Services","description":"Stop ATO and APP threats, MFA bombing, and other attacks and data breaches with secure decentralized biometric authentication.","link":"/industry-detail/financial-services"},
                {"name":"Transport & Logistics","description":"Meet sector regulations while eliminating fraud stemming from identity theft and streamlining user experience.","link":"/industry-detail/transport-logistics"},
                {"name":"Education","description":"Protect students and staff from ransomware, data breaches and financial fraud; streamline enrollment and secure restricted areas.","link":"/industry-detail/education"},
                {"name":"Healthcare Services","description":"Comply with HIPAA / GDPR while protecting against medical identity theft, insurance fraud and data breaches.","link":"/industry-detail/healthcare-services"}
            ]
        } />
